...
class Quality:
    ...
    def nameQuality(name):
        ...
        elif checkName(["720p", "hdtv", "x264"], all) or checkName(["720p", "BD", "x264"], all) or checkName(["hr.ws.pdtv.x264"], any):
            return Quality.HDTV
        elif checkName(["720p", "web.dl"], all) or checkName(["720p", "webhd"], all) or checkName(["720p", "itunes", "h.?264"], all):
